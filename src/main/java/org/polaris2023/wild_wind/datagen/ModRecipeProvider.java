...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void addSmeltingRecipes() {
        ...
        add(smelting(ModBlocks.BLUE_ICE_BRICKS, RecipeCategory.BUILDING_BLOCKS, ModBlocks.CRACKED_BLUE_ICE_BRICKS, 0.1f, 200), "smelting/");
    ...
    protected void addShapedRecipe() {
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_RED_SANDSTONE_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_RED_SANDSTONE.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.MOSSY_RED_SANDSTONE.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_RED_SANDSTONE_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_RED_SANDSTONE.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_RED_SANDSTONE_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_RED_SANDSTONE.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SMOOTH_RED_SANDSTONE_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, Blocks.SMOOTH_RED_SANDSTONE);
                    builder
                            .pattern(("SSS"))
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_PACKED_MUD_SLAB.get(), 6,
                builder -> {
                    ...
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.POLISHED_PACKED_MUD.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_PACKED_MUD_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.POLISHED_PACKED_MUD.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_PACKED_MUD_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.POLISHED_PACKED_MUD.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_MUD_BRICKS.get(), 1,
                builder -> {
                    unlockedBy(builder, Blocks.MUD_BRICK_SLAB);
                    builder
                            .pattern(("S"))
                            .pattern(("S"))
                            .define('S', Blocks.MUD_BRICK_SLAB);
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_DEEPSLATE_BRICKS.get(), 1,
                builder -> {
                    unlockedBy(builder, Blocks.DEEPSLATE_BRICK_SLAB);
                    builder
                            .pattern(("S"))
                            .pattern(("S"))
                            .define('S', Blocks.DEEPSLATE_BRICK_SLAB);
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_DEEPSLATE_TILES.get(), 1,
                builder -> {
                    unlockedBy(builder, Blocks.DEEPSLATE_TILE_SLAB);
                    builder
                            .pattern(("S"))
                            .pattern(("S"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.COBBLED_BLACKSTONE_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.COBBLED_BLACKSTONE.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.COBBLED_BLACKSTONE.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.COBBLED_BLACKSTONE_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.COBBLED_BLACKSTONE.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.COBBLED_BLACKSTONE_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.COBBLED_BLACKSTONE.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_COBBLED_BLACKSTONE_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_COBBLED_BLACKSTONE.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.MOSSY_COBBLED_BLACKSTONE.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_COBBLED_BLACKSTONE_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_COBBLED_BLACKSTONE.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_COBBLED_BLACKSTONE_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_COBBLED_BLACKSTONE.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_POLISHED_BLACKSTONE_BRICKS.get(), 1,
                builder -> {
                    unlockedBy(builder, Blocks.POLISHED_BLACKSTONE_SLAB);
                    builder
                            .pattern(("S"))
                            .pattern(("S"))
                            .define('S', Blocks.POLISHED_BLACKSTONE_SLAB);
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_POLISHED_BLACKSTONE_BRICK_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_POLISHED_BLACKSTONE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.MOSSY_POLISHED_BLACKSTONE_BRICKS.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_POLISHED_BLACKSTONE_BRICK_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_POLISHED_BLACKSTONE_BRICKS.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_POLISHED_BLACKSTONE_BRICK_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_POLISHED_BLACKSTONE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_COBBLED_DEEPSLATE_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_COBBLED_DEEPSLATE.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.MOSSY_COBBLED_DEEPSLATE.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_COBBLED_DEEPSLATE_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_COBBLED_DEEPSLATE.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_COBBLED_DEEPSLATE_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_COBBLED_DEEPSLATE.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.RED_SANDSTONE_BRICK_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.RED_SANDSTONE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.RED_SANDSTONE_BRICKS.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.RED_SANDSTONE_BRICK_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.RED_SANDSTONE_BRICKS.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.RED_SANDSTONE_BRICK_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.RED_SANDSTONE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_RED_SANDSTONE_BRICKS.get(), 1,
                builder -> {
                    unlockedBy(builder, ModBlocks.RED_SANDSTONE_BRICK_SLAB);
                    builder
                            .pattern(("S"))
                            .pattern(("S"))
                            .define('S', ModBlocks.RED_SANDSTONE_BRICK_SLAB);
                }));
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_RED_SANDSTONE_BRICK_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_RED_SANDSTONE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.MOSSY_RED_SANDSTONE_BRICKS.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_RED_SANDSTONE_BRICK_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_RED_SANDSTONE_BRICKS.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_RED_SANDSTONE_BRICK_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_RED_SANDSTONE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_PRISMARINE_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_PRISMARINE.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.MOSSY_PRISMARINE.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_PRISMARINE_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_PRISMARINE.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_PRISMARINE_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_PRISMARINE.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SNOW_BRICK_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.SNOW_BRICKS.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.SNOW_BRICKS.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SNOW_BRICK_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.SNOW_BRICKS.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SNOW_BRICK_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.SNOW_BRICKS.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_SNOW_BRICKS.get(), 1,
                builder -> {
                    ...
                    builder
                            .pattern(("S"))
                            .pattern(("S"))
                            .define('S', ModBlocks.SNOW_BRICK_SLAB);
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCITE_BRICK_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.CALCITE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.CALCITE_BRICKS.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCITE_BRICK_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.CALCITE_BRICKS.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CALCITE_BRICK_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.CALCITE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_CALCITE_BRICKS.get(), 1,
                builder -> {
                    unlockedBy(builder, ModBlocks.CALCITE_BRICK_SLAB);
                    builder
                            .pattern(("S"))
                            .pattern(("S"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DRIPSTONE_BRICK_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.DRIPSTONE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.DRIPSTONE_BRICKS.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DRIPSTONE_BRICK_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.DRIPSTONE_BRICKS.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DRIPSTONE_BRICK_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.DRIPSTONE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_DRIPSTONE_BRICKS.get(), 1,
                builder -> {
                    unlockedBy(builder, ModBlocks.DRIPSTONE_BRICK_SLAB);
                    builder
                            .pattern(("S"))
                            .pattern(("S"))
                            .define('S', ModBlocks.DRIPSTONE_BRICK_SLAB);
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_CALCITE_BRICK_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_CALCITE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.MOSSY_CALCITE_BRICKS.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_CALCITE_BRICK_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_CALCITE_BRICKS.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_CALCITE_BRICK_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_CALCITE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_DRIPSTONE_BRICK_SLAB.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_DRIPSTONE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
                            .define('S', ModBlocks.MOSSY_DRIPSTONE_BRICKS.get());
                }));
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_DRIPSTONE_BRICK_STAIRS.get(), 4,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_DRIPSTONE_BRICKS.get());
                    builder
                            .pattern(("S  "))
        ...
        add(shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOSSY_DRIPSTONE_BRICK_WALL.get(), 6,
                builder -> {
                    unlockedBy(builder, ModBlocks.MOSSY_DRIPSTONE_BRICKS.get());
                    builder
                            .pattern(("SSS"))
