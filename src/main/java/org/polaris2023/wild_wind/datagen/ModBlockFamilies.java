...
public class ModBlockFamilies {
	...
	public static final ModBlockFamily AZALEA = family(
			...
			ModBlocks.STRIPPED_AZALEA_LOG.get(), ModItems.AZALEA_BOAT.get(), ModItems.AZALEA_CHEST_BOAT.get(),
			ModBlocks.AZALEA_BUTTON.get(), ModBlocks.AZALEA_FENCE.get(), ModBlocks.AZALEA_FENCE_GATE.get(), ModBlocks.AZALEA_PRESSURE_PLATE.get(),
	...
	public static final ModBlockFamily PALM = family(
			...
			ModBlocks.STRIPPED_PALM_LOG.get(), ModItems.PALM_BOAT.get(), ModItems.PALM_CHEST_BOAT.get(), ModBlocks.PALM_BUTTON.get(),
			ModBlocks.PALM_FENCE.get(), ModBlocks.PALM_FENCE_GATE.get(), ModBlocks.PALM_PRESSURE_PLATE.get(),
	...
	public static final ModBlockFamily BAOBAB = family(
			...
			ModBlocks.STRIPPED_BAOBAB_LOG.get(), ModItems.BAOBAB_BOAT.get(), ModItems.BAOBAB_CHEST_BOAT.get(),
			ModBlocks.BAOBAB_BUTTON.get(), ModBlocks.BAOBAB_FENCE.get(), ModBlocks.BAOBAB_FENCE_GATE.get(), ModBlocks.BAOBAB_PRESSURE_PLATE.get(),
