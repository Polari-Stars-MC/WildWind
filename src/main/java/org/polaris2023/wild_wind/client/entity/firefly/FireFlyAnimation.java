...
public class FireFlyAnimation {
	public static final AnimationDefinition GLOW = AnimationDefinition.Builder.withLength(2.875F).looping()
		.addAnimation("bug", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(-13.2133F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("bug", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.6973F, -1.0F), AnimationChannel.Interpolations.LINEAR)
		))
