...
public enum ModTranslateKey implements Supplier<TranslatableContents> {
    ...
    @I18n(en_us = "%1$s was impaled on a ice spikes", zh_cn = "%1$s被冰刺刺穿了", zh_tw = "%1$s被冰刺刺穿了")
    ICE_SPIKES_DAMAGE("death", "attack", WildWindMod.MOD_ID, "ice_spikes_damage"),

    @I18n(en_us = "%1$s was impaled on a ice spikes while fighting %2$s", zh_cn = "%1$s在与%2$s的战斗中被冰刺刺穿了", zh_tw = "%1$s在與%2$s的戰鬥中被冰刺刺穿了")
    ICE_SPIKES_DAMAGE_PLAYER("death", "attack", WildWindMod.MOD_ID, "ice_spikes_damage", "player"),

    @I18n(en_us = "%1$s was skewered by a falling icicle", zh_cn = "%1$s被坠落的冰凌刺穿了", zh_tw = "%1$s被坠落的冰凌刺穿了")
    ICICLE_DAMAGE("death", "attack", WildWindMod.MOD_ID, "icicle_damage"),

    @I18n(en_us = "%1$s was skewered by a falling icicle while fighting %2$s", zh_cn = "%1$s在与%2$s的战斗中被坠落的冰凌刺穿了", zh_tw = "%1$s在與%2$s的戰鬥中被墜落的冰凌刺穿了")
    ICICLE_DAMAGE_PLAYER("death", "attack", WildWindMod.MOD_ID, "icicle_damage", "player"),

    @I18n(en_us = "%1$s was poked to death by a thorn", zh_cn = "%1$s被荆棘丛刺死了", zh_tw = "%1$s被荊棘叢刺死了")
    THORN_DAMAGE("death", "attack", WildWindMod.MOD_ID, "thorn_damage"),

    @I18n(en_us = "%1$s was poked to death by a thorn while trying to escape %2$s", zh_cn = "%1$s在试图逃离%2$s时被荆棘丛刺死了", zh_tw = "%1$s在試圖逃離%2$s時被荊棘叢刺死了")
    THORN_DAMAGE_PLAYER("death", "attack", WildWindMod.MOD_ID, "thorn_damage", "player"),
