...
public class ModItems {
    ...
    public static final DeferredItem<BasicItem> APPLE_CAKE = register("apple_cake", BasicItem::stackToMax);

    @I18n(en_us = "Berry Cake", zh_cn = "浆果派", zh_tw = "漿果派")
    public static final DeferredItem<BasicItem> BERRY_CAKE = register("berry_cake", BasicItem::stackToMax);
    ...
    public static final DeferredItem<BasicItem> BAKED_BEETROOT = register("baked_beetroot", BasicItem::stackToMax);

    @I18n(en_us = "Baked carrot", zh_tw = "烤胡蘿蔔", zh_cn = "烤胡萝卜")
    public static final DeferredItem<BasicItem> BAKED_CARROT = register("baked_carrot", BasicItem::stackToMax);

    @I18n(en_us = "Cooked Egg", zh_cn = "煎蛋", zh_tw = "煎蛋")
    public static final DeferredItem<BasicItem> COOKED_EGG = register("cooked_egg", BasicItem::stackToMax);
    ...
    public static final DeferredItem<BasicItem> BAKED_MUSHROOM = register("baked_mushroom", BasicItem::stackToMax);
